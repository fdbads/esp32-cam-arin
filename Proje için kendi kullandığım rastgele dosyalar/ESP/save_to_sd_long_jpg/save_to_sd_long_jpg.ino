...
void mem_monitor(){
  ...
  Serial.printf("largest_free_block: %d\n",heap_caps_get_largest_free_block(MALLOC_CAP_8BIT));
  Serial.printf("\n-Internal\n");
...
void loop() {
  ...
  if(fb == NULL) {
    ...
    String path = "/jpg_" + String(pictureNumber) +".jpg";
    ...
    if(!file){
        ...
        //Serial.printf("%d",fb->len); 300000 bytes
        ...
        if (config.jpeg_quality < 63) {
          Serial.printf("Decreasing jpg q  %d\n",config.jpeg_quality);
